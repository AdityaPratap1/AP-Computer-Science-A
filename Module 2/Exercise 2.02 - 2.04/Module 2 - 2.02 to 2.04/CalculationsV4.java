...
/**
 * Write a description of class CalculationsV4 here.
 * 
 * @author (your name) 
   ...
   public static void main(String[ ] args)
       {
        ...
        System.out.println("2.04 Lab Equations ");
        ...
        double dsum = dnum1 + dnum2 + dnum3;
        
        System.out.println("25 plus 9 equals " + sum);
        System.out.println("43.21 plus 3.14 plus 5.0 equals " + dsum );
        System.out.println();
        
        // Subtraction
        System.out.println("Subtraction");
                
        double ddiff = (dnum2-dnum3);
        
        System.out.println("16 minus 9 minus 25 equals " + diff );
        System.out.println("3.14 minus 5.0 equals " + ddiff);
        System.out.println();
        
        // Multiplication
        System.out.println("Multiplication");
        
        double dproduct = dnum2*dnum3*dnum3;
        
        System.out.println("25 times 9 = " + product ); 
        System.out.println("3.14 times 5.0 times 5.0 = " + dproduct );
        System.out.println();
        
        // Division
        System.out.println("Division");
        
        double dquot = dnum1/dnum3;
        
        System.out.println("9 divided by 25 = " + quot );
        System.out.println("43.21 divided by 5.0 = " + dquot );
        System.out.println();
         
        // Modulus operator
        System.out.println("Modulus");
        
        double dmod = dnum3%dnum2;
        
        System.out.println("The remainder when 16 divided by 9 is " + mod);
        System.out.println("The remainder when 5.0 divided by 3.14 is "+ dmod);
